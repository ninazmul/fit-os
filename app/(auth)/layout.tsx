...
const Layout = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="relative flex min-h-[100dvh] w-full items-start justify-center overflow-y-auto overflow-x-hidden bg-background px-2 py-2 sm:px-4 sm:py-4 sm:items-center lg:px-8">
      ...
      <div className="relative isolate mx-auto my-auto flex w-full max-w-6xl flex-col overflow-hidden rounded-3xl border border-border/60 bg-card/70 shadow-[0_30px_80px_-28px_rgba(0,0,0,0.45)] backdrop-blur-2xl lg:min-h-[680px] lg:flex-row">
        ...
        <main className="relative flex w-full flex-1 flex-col items-stretch justify-start overflow-y-auto p-3 sm:p-5 md:justify-center md:p-8">
          <div className="flex w-full flex-col items-center lg:hidden">
            ...
            <div className="mx-auto w-full min-w-0 max-w-sm flex-shrink-0 overflow-y-auto">
              {children}
            </div>
          </div>
